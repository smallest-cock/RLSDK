...
void UAdHocDelegates::EventAdHocOnNetworkChanged(const class TArray<struct FAdHocAccessPointInfo>& Ahapis)
{
	...
	memcpy_s(&EventAdHocOnNetworkChanged_Params.Ahapis, sizeof(EventAdHocOnNetworkChanged_Params.Ahapis), &Ahapis, sizeof(Ahapis));
...
void UAvatarDownloadComponent::HandleOnlineImageDownloaded(const struct FOnlineImageDownload& ImageInfo)
{
	...
	memcpy_s(&HandleOnlineImageDownloaded_Params.ImageInfo, sizeof(HandleOnlineImageDownloaded_Params.ImageInfo), &ImageInfo, sizeof(ImageInfo));
...
class UAvatarDownload* UAvatarDownloadComponent::GetAvatar(const struct FUniqueNetId& PlayerID, EAvatarSize Size)
{
	...
	memcpy_s(&GetAvatar_Params.PlayerID, sizeof(GetAvatar_Params.PlayerID), &PlayerID, sizeof(PlayerID));
...
void UAvatarDownloadComponent::DownloadAvatar(const struct FUniqueNetId& PlayerID, EAvatarSize Size, const class FString& URL)
{
	...
	memcpy_s(&DownloadAvatar_Params.PlayerID, sizeof(DownloadAvatar_Params.PlayerID), &PlayerID, sizeof(PlayerID));
	memcpy_s(&DownloadAvatar_Params.Size, sizeof(DownloadAvatar_Params.Size), &Size, sizeof(Size));
	memcpy_s(&DownloadAvatar_Params.URL, sizeof(DownloadAvatar_Params.URL), &URL, sizeof(URL));
...
void UAvatarDownloadComponent::StoreNewAvatars(EAvatarSize Size, const struct FScriptDelegate& ReadOnlineAvatarCompleteDelegate, class TArray<struct FUniqueNetId>& NewPlayerIDs)
{
	...
	memcpy_s(&StoreNewAvatars_Params.Size, sizeof(StoreNewAvatars_Params.Size), &Size, sizeof(Size));
...
void UAvatarDownloadComponent::ProcessOldRequests(EAvatarSize SizeType, const struct FScriptDelegate& ReadOnlineAvatarCompleteDelegate, class TArray<struct FUniqueNetId>& InPlayerIDs, class TArray<struct FUniqueNetId>& NewRequestIDs)
{
	...
	memcpy_s(&ProcessOldRequests_Params.SizeType, sizeof(ProcessOldRequests_Params.SizeType), &SizeType, sizeof(SizeType));
	memcpy_s(&ProcessOldRequests_Params.ReadOnlineAvatarCompleteDelegate, sizeof(ProcessOldRequests_Params.ReadOnlineAvatarCompleteDelegate), &ReadOnlineAvatarCompleteDelegate, sizeof(ReadOnlineAvatarCompleteDelegate));
...
bool UAvatarDownloadComponent::TryAddAvatarTextureCallback(const struct FUniqueNetId& PlayerNetId, EAvatarSize Size, const struct FScriptDelegate& ReadOnlineAvatarCompleteDelegate)
{
	...
	memcpy_s(&TryAddAvatarTextureCallback_Params.PlayerNetId, sizeof(TryAddAvatarTextureCallback_Params.PlayerNetId), &PlayerNetId, sizeof(PlayerNetId));
...
void UImageDecoder::RequestDecodeImage(const class FString& RequestURL, EImageType ImageType, const struct FScriptDelegate& FinishedCallback, class TArray<uint8_t>& ImageData)
{
	...
	memcpy_s(&RequestDecodeImage_Params.RequestURL, sizeof(RequestDecodeImage_Params.RequestURL), &RequestURL, sizeof(RequestURL));
	memcpy_s(&RequestDecodeImage_Params.ImageType, sizeof(RequestDecodeImage_Params.ImageType), &ImageType, sizeof(ImageType));
...
void UImageDecoder::ImageDecodedDelegate(const class FString& RequestURL, const struct FImageLayout& Image)
{
	...
	memcpy_s(&ImageDecodedDelegate_Params.RequestURL, sizeof(ImageDecodedDelegate_Params.RequestURL), &RequestURL, sizeof(RequestURL));
	memcpy_s(&ImageDecodedDelegate_Params.Image, sizeof(ImageDecodedDelegate_Params.Image), &Image, sizeof(Image));
...
class UAsyncTask* UOnlineAuthInterfaceImpl::RequestAccountAuthorization(const struct FUniqueNetId& PlayerID, const struct FScriptDelegate& Callback)
{
	...
	memcpy_s(&RequestAccountAuthorization_Params.PlayerID, sizeof(RequestAccountAuthorization_Params.PlayerID), &PlayerID, sizeof(PlayerID));
...
void UOnlineAuthInterfaceImpl::OnAccountAuthorization(const class FString& Token)
{
	...
	memcpy_s(&OnAccountAuthorization_Params.Token, sizeof(OnAccountAuthorization_Params.Token), &Token, sizeof(Token));
...
void UOnlineAuthInterfaceImpl::OnReceivedAuthCode(bool bSuccess, const class FString& Code)
{
	...
	memcpy_s(&OnReceivedAuthCode_Params.Code, sizeof(OnReceivedAuthCode_Params.Code), &Code, sizeof(Code));
...
void UOnlineFriendsInterfaceImpl::OnReceivedLinkedAccount(bool bSuccess, const class TArray<struct FLinkedAccountData>& LinkedAccountData)
{
	...
	memcpy_s(&OnReceivedLinkedAccount_Params.LinkedAccountData, sizeof(OnReceivedLinkedAccount_Params.LinkedAccountData), &LinkedAccountData, sizeof(LinkedAccountData));
...
void UOnlineGameInterfaceImpl::ClearReportMatchmakingInfoDelegate(const struct FScriptDelegate& OldDelegate)
{
	...
	memcpy_s(&ClearReportMatchmakingInfoDelegate_Params.OldDelegate, sizeof(ClearReportMatchmakingInfoDelegate_Params.OldDelegate), &OldDelegate, sizeof(OldDelegate));
...
void UOnlineGameInterfaceImpl::AddReportMatchmakingInfoDelegate(const struct FScriptDelegate& NewDelegate)
{
	...
	memcpy_s(&AddReportMatchmakingInfoDelegate_Params.NewDelegate, sizeof(AddReportMatchmakingInfoDelegate_Params.NewDelegate), &NewDelegate, sizeof(NewDelegate));
...
void UOnlineGameInterfaceImpl::EventReportMatchmakingInfo(const class FString& NewInfo)
{
	...
	memcpy_s(&EventReportMatchmakingInfo_Params.NewInfo, sizeof(EventReportMatchmakingInfo_Params.NewInfo), &NewInfo, sizeof(NewInfo));
...
void UOnlineImageDownloaderWeb::QueueURLForDownload(const class FString& NewURL, const struct FScriptDelegate& InternalCallbackOnComplete, const struct FScriptDelegate& ExternalCallback, bool bSupportSRGB)
{
	...
	memcpy_s(&QueueURLForDownload_Params.NewURL, sizeof(QueueURLForDownload_Params.NewURL), &NewURL, sizeof(NewURL));
	memcpy_s(&QueueURLForDownload_Params.InternalCallbackOnComplete, sizeof(QueueURLForDownload_Params.InternalCallbackOnComplete), &InternalCallbackOnComplete, sizeof(InternalCallbackOnComplete));
	memcpy_s(&QueueURLForDownload_Params.ExternalCallback, sizeof(QueueURLForDownload_Params.ExternalCallback), &ExternalCallback, sizeof(ExternalCallback));
...
void UOnlineImageDownloaderWeb::RequestOnlineImages(const struct FScriptDelegate& FinishedCallback, bool bSupportSRGB, class TArray<class FString>& URLs)
{
	...
	memcpy_s(&RequestOnlineImages_Params.FinishedCallback, sizeof(RequestOnlineImages_Params.FinishedCallback), &FinishedCallback, sizeof(FinishedCallback));
	...
	memcpy_s(&URLs, sizeof(URLs), &RequestOnlineImages_Params.URLs, sizeof(RequestOnlineImages_Params.URLs));
};
...
void UOnlineImageDownloaderWeb::HandleImageDecoded(const class FString& RequestedURL, struct FImageLayout& DecodedImage)
{
	...
	memcpy_s(&HandleImageDecoded_Params.RequestedURL, sizeof(HandleImageDecoded_Params.RequestedURL), &RequestedURL, sizeof(RequestedURL));
	memcpy_s(&HandleImageDecoded_Params.DecodedImage, sizeof(HandleImageDecoded_Params.DecodedImage), &DecodedImage, sizeof(DecodedImage));

	this->ProcessEvent(uFnHandleImageDecoded, &HandleImageDecoded_Params, nullptr);

	memcpy_s(&DecodedImage, sizeof(DecodedImage), &HandleImageDecoded_Params.DecodedImage, sizeof(HandleImageDecoded_Params.DecodedImage));
};
...
void UOnlineImageDownloaderWeb::EventImageDecoded(const class FString& RequestURL, struct FImageLayout& Image)
{
	...
	memcpy_s(&EventImageDecoded_Params.RequestURL, sizeof(EventImageDecoded_Params.RequestURL), &RequestURL, sizeof(RequestURL));
	memcpy_s(&EventImageDecoded_Params.Image, sizeof(EventImageDecoded_Params.Image), &Image, sizeof(Image));

	this->ProcessEvent(uFnEventImageDecoded, &EventImageDecoded_Params, nullptr);

	memcpy_s(&Image, sizeof(Image), &EventImageDecoded_Params.Image, sizeof(EventImageDecoded_Params.Image));
};
...
void UOnlineImageDownloaderWeb::OnOnlineImageFinished(const struct FOnlineImageDownload& ImageInfo)
{
	...
	memcpy_s(&OnOnlineImageFinished_Params.ImageInfo, sizeof(OnOnlineImageFinished_Params.ImageInfo), &ImageInfo, sizeof(ImageInfo));
...
void UOnlineLobbyInterfaceImpl::ClearHostStartPlayTogetherDelegate(const struct FScriptDelegate& InDelegate)
{
	...
	memcpy_s(&ClearHostStartPlayTogetherDelegate_Params.InDelegate, sizeof(ClearHostStartPlayTogetherDelegate_Params.InDelegate), &InDelegate, sizeof(InDelegate));
...
void UOnlineLobbyInterfaceImpl::AddHostStartPlayTogetherDelegate(const struct FScriptDelegate& InDelegate)
{
	...
	memcpy_s(&AddHostStartPlayTogetherDelegate_Params.InDelegate, sizeof(AddHostStartPlayTogetherDelegate_Params.InDelegate), &InDelegate, sizeof(InDelegate));
...
void UOnlineLobbyInterfaceImpl::OnHostStartPlayTogether(uint8_t LocalUserNum)
{
	...
	memcpy_s(&OnHostStartPlayTogether_Params.LocalUserNum, sizeof(OnHostStartPlayTogether_Params.LocalUserNum), &LocalUserNum, sizeof(LocalUserNum));
...
void UOnlineLobbyInterfaceImpl::ClearLobbyErrorDelegate(const struct FScriptDelegate& LobbyErrorDelegate)
{
	...
	memcpy_s(&ClearLobbyErrorDelegate_Params.LobbyErrorDelegate, sizeof(ClearLobbyErrorDelegate_Params.LobbyErrorDelegate), &LobbyErrorDelegate, sizeof(LobbyErrorDelegate));
...
void UOnlineLobbyInterfaceImpl::AddLobbyErrorDelegate(const struct FScriptDelegate& LobbyErrorDelegate)
{
	...
	memcpy_s(&AddLobbyErrorDelegate_Params.LobbyErrorDelegate, sizeof(AddLobbyErrorDelegate_Params.LobbyErrorDelegate), &LobbyErrorDelegate, sizeof(LobbyErrorDelegate));
...
void UOnlineLobbyInterfaceImpl::OnLobbyError(const class FString& Error)
{
	...
	memcpy_s(&OnLobbyError_Params.Error, sizeof(OnLobbyError_Params.Error), &Error, sizeof(Error));
...
bool UOnlineLobbyInterfaceImpl::eventGetLobbyMembers(struct FUniqueLobbyId& LobbyId, class TArray<struct FLobbyMember>& Members)
{
	...
	memcpy_s(&GetLobbyMembers_Params.LobbyId, sizeof(GetLobbyMembers_Params.LobbyId), &LobbyId, sizeof(LobbyId));
	memcpy_s(&GetLobbyMembers_Params.Members, sizeof(GetLobbyMembers_Params.Members), &Members, sizeof(Members));
...
void UOnlineLobbyInterfaceImpl::ClearLobbySessionCretedeDelegate(const struct FScriptDelegate& LobbySessionCreatedDelegate)
{
	...
	memcpy_s(&ClearLobbySessionCretedeDelegate_Params.LobbySessionCreatedDelegate, sizeof(ClearLobbySessionCretedeDelegate_Params.LobbySessionCreatedDelegate), &LobbySessionCreatedDelegate, sizeof(LobbySessionCreatedDelegate));
...
void UOnlineLobbyInterfaceImpl::ClearLobbySessionCreatedDelegate(const struct FScriptDelegate& LobbySessionCreatedDelegate)
{
	...
	memcpy_s(&ClearLobbySessionCreatedDelegate_Params.LobbySessionCreatedDelegate, sizeof(ClearLobbySessionCreatedDelegate_Params.LobbySessionCreatedDelegate), &LobbySessionCreatedDelegate, sizeof(LobbySessionCreatedDelegate));
...
void UOnlineLobbyInterfaceImpl::AddLobbySessionCreatedDelegate(const struct FScriptDelegate& LobbySessionCreatedDelegate)
{
	...
	memcpy_s(&AddLobbySessionCreatedDelegate_Params.LobbySessionCreatedDelegate, sizeof(AddLobbySessionCreatedDelegate_Params.LobbySessionCreatedDelegate), &LobbySessionCreatedDelegate, sizeof(LobbySessionCreatedDelegate));
...
int32_t UOnlineLobbyInterfaceImpl::eventGetLobbyIndex(struct FUniqueLobbyId& LobbyId)
{
	...
	memcpy_s(&GetLobbyIndex_Params.LobbyId, sizeof(GetLobbyIndex_Params.LobbyId), &LobbyId, sizeof(LobbyId));
...
void UOnlineLobbyInterfaceImpl::RemoveLocalPlayerFromSession(struct FUniqueNetId& PartyMember)
{
	...
	memcpy_s(&RemoveLocalPlayerFromSession_Params.PartyMember, sizeof(RemoveLocalPlayerFromSession_Params.PartyMember), &PartyMember, sizeof(PartyMember));

	this->ProcessEvent(uFnRemoveLocalPlayerFromSession, &RemoveLocalPlayerFromSession_Params, nullptr);

	memcpy_s(&PartyMember, sizeof(PartyMember), &RemoveLocalPlayerFromSession_Params.PartyMember, sizeof(RemoveLocalPlayerFromSession_Params.PartyMember));
};
...
void UOnlineLobbyInterfaceImpl::AddLocalPartyMemberToSession(struct FUniqueNetId& NewPartyMember)
{
	...
	memcpy_s(&AddLocalPartyMemberToSession_Params.NewPartyMember, sizeof(AddLocalPartyMemberToSession_Params.NewPartyMember), &NewPartyMember, sizeof(NewPartyMember));

	this->ProcessEvent(uFnAddLocalPartyMemberToSession, &AddLocalPartyMemberToSession_Params, nullptr);

	memcpy_s(&NewPartyMember, sizeof(NewPartyMember), &AddLocalPartyMemberToSession_Params.NewPartyMember, sizeof(AddLocalPartyMemberToSession_Params.NewPartyMember));
};
...
void UOnlineLobbyInterfaceImpl::eventTriggerLobbyDestroyedDelegates(int32_t LobbyIndex, ELobbyKickReason Reason)
{
	...
	memcpy_s(&TriggerLobbyDestroyedDelegates_Params.LobbyIndex, sizeof(TriggerLobbyDestroyedDelegates_Params.LobbyIndex), &LobbyIndex, sizeof(LobbyIndex));
	memcpy_s(&TriggerLobbyDestroyedDelegates_Params.Reason, sizeof(TriggerLobbyDestroyedDelegates_Params.Reason), &Reason, sizeof(Reason));
...
void UOnlineLobbyInterfaceImpl::ClearLobbyDestroyedDelegate(const struct FScriptDelegate& LobbyDestroyedDelegate)
{
	...
	memcpy_s(&ClearLobbyDestroyedDelegate_Params.LobbyDestroyedDelegate, sizeof(ClearLobbyDestroyedDelegate_Params.LobbyDestroyedDelegate), &LobbyDestroyedDelegate, sizeof(LobbyDestroyedDelegate));
...
void UOnlineLobbyInterfaceImpl::AddLobbyDestroyedDelegate(const struct FScriptDelegate& LobbyDestroyedDelegate)
{
	...
	memcpy_s(&AddLobbyDestroyedDelegate_Params.LobbyDestroyedDelegate, sizeof(AddLobbyDestroyedDelegate_Params.LobbyDestroyedDelegate), &LobbyDestroyedDelegate, sizeof(LobbyDestroyedDelegate));
...
void UOnlineLobbyInterfaceImpl::OnLobbyDestroyed(ELobbyKickReason Reason, struct FUniqueLobbyId& LobbyId)
{
	...
	memcpy_s(&OnLobbyDestroyed_Params.Reason, sizeof(OnLobbyDestroyed_Params.Reason), &Reason, sizeof(Reason));
	memcpy_s(&OnLobbyDestroyed_Params.LobbyId, sizeof(OnLobbyDestroyed_Params.LobbyId), &LobbyId, sizeof(LobbyId));

	this->ProcessEvent(uFnOnLobbyDestroyed, &OnLobbyDestroyed_Params, nullptr);

	memcpy_s(&LobbyId, sizeof(LobbyId), &OnLobbyDestroyed_Params.LobbyId, sizeof(OnLobbyDestroyed_Params.LobbyId));
};
...
void UOnlineLobbyInterfaceImpl::OnLobbyInvite(bool bAccepted, struct FUniqueLobbyId& LobbyId, struct FUniqueNetId& FriendId)
{
	...
	memcpy_s(&LobbyId, sizeof(LobbyId), &OnLobbyInvite_Params.LobbyId, sizeof(OnLobbyInvite_Params.LobbyId));
	memcpy_s(&FriendId, sizeof(FriendId), &OnLobbyInvite_Params.FriendId, sizeof(OnLobbyInvite_Params.FriendId));
};
...
void UOnlineLobbyInterfaceImpl::eventTriggerLobbyJoinGameDelegates(int32_t LobbyIndex, const class FString& ServerIP, struct FUniqueNetId& ServerId)
{
	...
	memcpy_s(&ServerId, sizeof(ServerId), &TriggerLobbyJoinGameDelegates_Params.ServerId, sizeof(TriggerLobbyJoinGameDelegates_Params.ServerId));
};
...
void UOnlineLobbyInterfaceImpl::OnLobbyJoinGame(const class FString& ServerIP, struct FActiveLobbyInfo& LobbyInfo, struct FUniqueNetId& ServerId)
{
	...
	memcpy_s(&OnLobbyJoinGame_Params.LobbyInfo, sizeof(OnLobbyJoinGame_Params.LobbyInfo), &LobbyInfo, sizeof(LobbyInfo));
	...
	memcpy_s(&LobbyInfo, sizeof(LobbyInfo), &OnLobbyJoinGame_Params.LobbyInfo, sizeof(OnLobbyJoinGame_Params.LobbyInfo));
	memcpy_s(&ServerId, sizeof(ServerId), &OnLobbyJoinGame_Params.ServerId, sizeof(OnLobbyJoinGame_Params.ServerId));
};
...
void UOnlineLobbyInterfaceImpl::OnLobbyReceiveBinaryData(int32_t MemberIndex, struct FActiveLobbyInfo& LobbyInfo, class TArray<uint8_t>& Data)
{
	...
	memcpy_s(&OnLobbyReceiveBinaryData_Params.LobbyInfo, sizeof(OnLobbyReceiveBinaryData_Params.LobbyInfo), &LobbyInfo, sizeof(LobbyInfo));
	...
	memcpy_s(&LobbyInfo, sizeof(LobbyInfo), &OnLobbyReceiveBinaryData_Params.LobbyInfo, sizeof(OnLobbyReceiveBinaryData_Params.LobbyInfo));
...
void UOnlineLobbyInterfaceImpl::OnLobbyReceiveMessage(int32_t MemberIndex, const class FString& Type, const class FString& Message, struct FActiveLobbyInfo& LobbyInfo)
{
	...
	memcpy_s(&OnLobbyReceiveMessage_Params.LobbyInfo, sizeof(OnLobbyReceiveMessage_Params.LobbyInfo), &LobbyInfo, sizeof(LobbyInfo));

	this->ProcessEvent(uFnOnLobbyReceiveMessage, &OnLobbyReceiveMessage_Params, nullptr);

	memcpy_s(&LobbyInfo, sizeof(LobbyInfo), &OnLobbyReceiveMessage_Params.LobbyInfo, sizeof(OnLobbyReceiveMessage_Params.LobbyInfo));
};
...
void UOnlineLobbyInterfaceImpl::OnLobbyMemberStatusUpdate(int32_t MemberIndex, int32_t InstigatorIndex, const class FString& Status, struct FActiveLobbyInfo& LobbyInfo)
{
	...
	memcpy_s(&OnLobbyMemberStatusUpdate_Params.LobbyInfo, sizeof(OnLobbyMemberStatusUpdate_Params.LobbyInfo), &LobbyInfo, sizeof(LobbyInfo));

	this->ProcessEvent(uFnOnLobbyMemberStatusUpdate, &OnLobbyMemberStatusUpdate_Params, nullptr);

	memcpy_s(&LobbyInfo, sizeof(LobbyInfo), &OnLobbyMemberStatusUpdate_Params.LobbyInfo, sizeof(OnLobbyMemberStatusUpdate_Params.LobbyInfo));
};
...
void UOnlineLobbyInterfaceImpl::OnLobbyMemberSettingsUpdate(int32_t MemberIndex, struct FActiveLobbyInfo& LobbyInfo)
{
	...
	memcpy_s(&OnLobbyMemberSettingsUpdate_Params.LobbyInfo, sizeof(OnLobbyMemberSettingsUpdate_Params.LobbyInfo), &LobbyInfo, sizeof(LobbyInfo));

	this->ProcessEvent(uFnOnLobbyMemberSettingsUpdate, &OnLobbyMemberSettingsUpdate_Params, nullptr);

	memcpy_s(&LobbyInfo, sizeof(LobbyInfo), &OnLobbyMemberSettingsUpdate_Params.LobbyInfo, sizeof(OnLobbyMemberSettingsUpdate_Params.LobbyInfo));
};
...
void UOnlineLobbyInterfaceImpl::OnLobbySettingsUpdate(struct FActiveLobbyInfo& LobbyInfo)
{
	...
	memcpy_s(&OnLobbySettingsUpdate_Params.LobbyInfo, sizeof(OnLobbySettingsUpdate_Params.LobbyInfo), &LobbyInfo, sizeof(LobbyInfo));

	this->ProcessEvent(uFnOnLobbySettingsUpdate, &OnLobbySettingsUpdate_Params, nullptr);

	memcpy_s(&LobbyInfo, sizeof(LobbyInfo), &OnLobbySettingsUpdate_Params.LobbyInfo, sizeof(OnLobbySettingsUpdate_Params.LobbyInfo));
};
...
void UOnlineLobbyInterfaceImpl::eventTriggerJoinLobbyCompleteDelegates(bool bWasSuccessful, const class FString& Error, struct FActiveLobbyInfo& LobbyInfo, struct FUniqueLobbyId& LobbyUID)
{
	...
	memcpy_s(&TriggerJoinLobbyCompleteDelegates_Params.LobbyInfo, sizeof(TriggerJoinLobbyCompleteDelegates_Params.LobbyInfo), &LobbyInfo, sizeof(LobbyInfo));
	...
	memcpy_s(&LobbyInfo, sizeof(LobbyInfo), &TriggerJoinLobbyCompleteDelegates_Params.LobbyInfo, sizeof(TriggerJoinLobbyCompleteDelegates_Params.LobbyInfo));
	memcpy_s(&LobbyUID, sizeof(LobbyUID), &TriggerJoinLobbyCompleteDelegates_Params.LobbyUID, sizeof(TriggerJoinLobbyCompleteDelegates_Params.LobbyUID));
};
...
void UOnlineLobbyInterfaceImpl::OnJoinLobbyComplete(bool bWasSuccessful, const class FString& Error, struct FActiveLobbyInfo& LobbyInfo, struct FUniqueLobbyId& LobbyUID)
{
	...
	memcpy_s(&OnJoinLobbyComplete_Params.LobbyInfo, sizeof(OnJoinLobbyComplete_Params.LobbyInfo), &LobbyInfo, sizeof(LobbyInfo));
	...
	memcpy_s(&LobbyInfo, sizeof(LobbyInfo), &OnJoinLobbyComplete_Params.LobbyInfo, sizeof(OnJoinLobbyComplete_Params.LobbyInfo));
	memcpy_s(&LobbyUID, sizeof(LobbyUID), &OnJoinLobbyComplete_Params.LobbyUID, sizeof(OnJoinLobbyComplete_Params.LobbyUID));
};
...
void UOnlineLobbyInterfaceImpl::OnCreateLobbyComplete(bool bWasSuccessful, const class FString& Error, struct FUniqueLobbyId& LobbyId)
{
	...
	memcpy_s(&LobbyId, sizeof(LobbyId), &OnCreateLobbyComplete_Params.LobbyId, sizeof(OnCreateLobbyComplete_Params.LobbyId));
};
...
void UOnlinePersistentAuthInterfaceImpl::ClearUnderageUserDetectedDelegate(const struct FScriptDelegate& Callback)
{
	...
	memcpy_s(&ClearUnderageUserDetectedDelegate_Params.Callback, sizeof(ClearUnderageUserDetectedDelegate_Params.Callback), &Callback, sizeof(Callback));
...
void UOnlinePersistentAuthInterfaceImpl::AddUnderageUserDetectedDelegate(const struct FScriptDelegate& Callback)
{
	...
	memcpy_s(&AddUnderageUserDetectedDelegate_Params.Callback, sizeof(AddUnderageUserDetectedDelegate_Params.Callback), &Callback, sizeof(Callback));
...
void UOnlinePersistentAuthInterfaceImpl::OnUnderageUserDetected(uint8_t LocalUserNum, const class FString& ParentalConsentURL)
{
	...
	memcpy_s(&OnUnderageUserDetected_Params.LocalUserNum, sizeof(OnUnderageUserDetected_Params.LocalUserNum), &LocalUserNum, sizeof(LocalUserNum));
	memcpy_s(&OnUnderageUserDetected_Params.ParentalConsentURL, sizeof(OnUnderageUserDetected_Params.ParentalConsentURL), &ParentalConsentURL, sizeof(ParentalConsentURL));
...
void UOnlinePersistentAuthInterfaceImpl::ClearRequestPinGrantCodeDelegate(uint8_t LocalUserNum, const struct FScriptDelegate& Callback)
{
	...
	memcpy_s(&ClearRequestPinGrantCodeDelegate_Params.LocalUserNum, sizeof(ClearRequestPinGrantCodeDelegate_Params.LocalUserNum), &LocalUserNum, sizeof(LocalUserNum));
	memcpy_s(&ClearRequestPinGrantCodeDelegate_Params.Callback, sizeof(ClearRequestPinGrantCodeDelegate_Params.Callback), &Callback, sizeof(Callback));
...
void UOnlinePersistentAuthInterfaceImpl::AddRequestPinGrantCodeDelegate(uint8_t LocalUserNum, const struct FScriptDelegate& Callback)
{
	...
	memcpy_s(&AddRequestPinGrantCodeDelegate_Params.LocalUserNum, sizeof(AddRequestPinGrantCodeDelegate_Params.LocalUserNum), &LocalUserNum, sizeof(LocalUserNum));
	memcpy_s(&AddRequestPinGrantCodeDelegate_Params.Callback, sizeof(AddRequestPinGrantCodeDelegate_Params.Callback), &Callback, sizeof(Callback));
